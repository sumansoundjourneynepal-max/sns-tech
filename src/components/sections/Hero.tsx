                        ...
                        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight mb-6">
                            ...
                            <div className="flex items-center justify-center gap-4 mt-4">
                                ...
                                >
                                    ...
                                    <span
                                        className={`bg-gradient-to-r ${services[currentService].color} bg-clip-text text-transparent font-bold leading-[1.6]`}
                                    >
                    ...
                    >
                        ...
                        >
                            <Button
                                asChild
                                size="lg"
                                className="relative overflow-hidden bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-10 py-6 text-lg font-semibold rounded-full shadow-2xl hover:shadow-blue-500/25 transition-all duration-300"
                            >
                                <Link to="/contact">
                                    <motion.div
                        ...
                        <motion.div whileHover={{scale: 1.05}} whileTap={{scale: 0.95}}>
                            <Button
                                variant="outline"
                                size="lg"
                                className="px-10 py-6 text-lg font-semibold rounded-full border-white/30 text-white hover:bg-white/10 hover:text-white backdrop-blur-sm transition-all duration-300 bg-transparent"
                            >
