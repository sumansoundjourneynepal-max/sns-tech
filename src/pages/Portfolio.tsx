...
import { ExternalLink, Facebook, Instagram, Youtube, ArrowRight, Globe, Smartphone, TrendingUp, Palette, Share2 } from 'lucide-react'
      ...
      <AnimatedSection className="py-20 lg:py-32">
        <div className="container mx-auto px-4 lg:px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Developing custom mobile applications and expanding into smart digital solutions 
                  ...
                  <div className="grid lg:grid-cols-2 gap-8 items-center">
                    <div>
                      ...
                      <p className="text-muted-foreground text-lg leading-relaxed mb-6">
                        We're expanding our expertise into mobile app development, creating intuitive, 
                        high-performance applications that deliver exceptional user experiences across 
